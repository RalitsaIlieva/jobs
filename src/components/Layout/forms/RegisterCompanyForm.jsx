...
const RegisterCompanyForm = () => {
  ...
  const onSubmit = (data) => {
    try {
      localStorage.setItem("submissionCompanyEmail", JSON.stringify(data.email))
      localStorage.setItem("submissionCompanyPassword", JSON.stringify(data.password))
      alert(t("success"));
      navigate('/company')
    } catch (error) {
      alert(t("fail"));
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <Typography mb={-1}>{t("ownerName")}</Typography>
          <Controller
            name="ownerName"
            control={control}
            rules={{ required: t("validations:required") }}
          ...
          />
          <Typography mb={-1}>{t("gsm")}</Typography>
          <Controller
            name="gsm"
            control={control}
            rules={{ required: t("validations:required") }}
